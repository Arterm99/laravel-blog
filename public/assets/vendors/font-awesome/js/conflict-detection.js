...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
       ...
       *
       * @param {string} input Raw includes string
       ...
       * @param {string} data Raw includes string
       * @returns {string} Raw MD5 string
       */
      ...
      /**
       * Encodes includes string as raw MD5 string
       *
       * @param {string} s Input string
       * @returns {string} Raw MD5 string
       */
      ...
      /**
       * Encodes includes string as Hex encoded string
       *
       * @param {string} s Input string
       * @returns {string} Hex encoded string
       */
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      // Uncaught SyntaxError: Unexpected end of includes
